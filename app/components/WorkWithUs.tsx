  ...
  return (
    <>
      <div className="2xl:my-44 my-32">
        ...
        <div>
          <Link href="/contact" className={`group  block w-fit py-12 px-10 uppercase  ${theme ? "text-(--offWhite)" : "text-(--charcoleBlack) "}`}>
            <div className="w-80">
              <h4 className="text-[10vw] font-light leading-[1cap] text-right">Work</h4>
            </div>
            <div className="flex items-center gap-0">
              ...
              <div>
                <h2 className="text-[10vw] font-light leading-[1.2cap]">With</h2>
                <h2 className="text-[10vw] font-light leading-[1.2cap]">Us</h2>
              </div>
            </div>
          </Link>
        </div>
